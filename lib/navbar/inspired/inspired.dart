...
import '../styles/chipstyle.dart';
import 'package:flutter/material.dart';
import 'transition_container.dart';
import '../styles/count_style.dart';
...
class _InspiredState extends State<Inspired> with TickerProviderStateMixin {
  ...
  static const _transitionDuration = 200;
  ...
  Widget buildItem(BuildContext context,
    ...
    return Container(
      padding:
          EdgeInsets.only(bottom: widget.padbottom! - 4, top: widget.padTop!),
      child: Column(
